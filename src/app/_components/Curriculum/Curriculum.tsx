...
import CV from '../../../../public/curriculum-frontEnd.png'

export const Curriculum = () => {
  return (
    <section className="w-full h-full flex flex-col items-center justify-between md:gap-10">
      <h1 className="w-fit mx-auto p-2 text-3xl font-bold text-white text-center">
        Curriculum & Réseaux
      </h1>
      <section className="w-full h-full flex flex-1 flex-col md:flex-row items-center justify-between">
        ...
        <div className="w-full h-full flex flex-col gap-4 items-center justify-center">
          ...
          <a
            href="https://www.linkedin.com/in/tyron-william-chanu-483956171/"
            target="_blank"
          ...
          <a
            href="https://github.com/Tyronwilliam?tab=overview&from=2023-12-01&to=2023-12-31"
            target="_blank"
