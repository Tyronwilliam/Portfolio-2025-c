...
export const Apropos = ({}: Props) => {
  return (
    <section className="w-full md:h-[759px] flex flex-col items-center gap-10 md:gap-0 md:p-0 lg:p-4 lg:pt-0 grow ">
      ...
      <section className="w-full flex flex-col md:flex-row gap-10 grow p-4  pt-2 md:p-0">
        {/* Parcours */}
        <div className="md:flex flex-col space-y-4   md:h-[calc(100vh-430px)] md:overflow-y-scroll scroll-container scrollbar-hide lg:overflow-auto">
          <h1 className="text-3xl font-bold text-center ">Mon parcours</h1>
          <div className="glassomorph_effect_no_radius px-8 p-6  w-full h-fit flex flex-col gap-4">
            <div className="space-y-2 ">
              <p>
                Après plusieurs emplois alimentaires, j'ai découvert le
                développement web un peu par hasard, pendant le Covid, en
                tentant de créer mes propres jeux vidéo. Très vite, j'ai
                commencé à coder de petits sites avec HTML, CSS, JS.
              </p>
            </div>
            <p>
        ...
        {/* BOOTOM */}
        <section className="flex flex-col text-sm gap-2  md:h-[calc(100vh-430px)] md:overflow-y-scroll scroll-container lg:overflow-auto scrollbar-hide">
          <div className="space-y-2">
